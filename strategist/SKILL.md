...
**Search Strategy** (load `~/.claude/skills/academic-paper-strategist/references/search_strategy.md` for details):
...
**Tools Used**:
- `web_fetch` (semantic/web search — fetch arXiv, PhilPapers, Google Scholar pages)
- `bash` with `curl` (platform-specific API searches)
- Platform-specific search (PhilPapers, arXiv)

**Quality Validation**:
After search, I'll run `~/.claude/skills/academic-paper-strategist/scripts/evaluate_samples.py` to generate evaluation report:
```bash
python ~/.claude/skills/academic-paper-strategist/scripts/evaluate_samples.py
```
...
**Load Reference**: `~/.claude/skills/academic-paper-strategist/references/search_strategy.md` for detailed methodology
...
**Validation**: Run `~/.claude/skills/academic-paper-strategist/scripts/gap_analysis.py` to ensure quality:
```bash
python ~/.claude/skills/academic-paper-strategist/scripts/gap_analysis.py
```
...
I will evaluate the outline as if I were a platform reviewer, using **7 dimensions** (load `~/.claude/skills/academic-paper-strategist/references/quality_standards.md` for criteria):
...
Load `~/.claude/skills/academic-paper-strategist/references/quality_standards.md` for full rubrics.
...
```
~/.claude/skills/academic-paper-strategist/references/quality_standards.md
```
...
- **Requires web access**: Literature search uses `web_fetch` and `bash curl` for fetching papers from PhilPapers, arXiv, Google Scholar, and similar platforms
