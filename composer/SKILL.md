...
2. **Load reference documents**:
   ...
   - Section writing guides (`~/.claude/skills/academic-paper-composer/references/section_guides.md`)
   - Quality standards (`~/.claude/skills/academic-paper-composer/references/writing_standards.md`)
...
3. **Check section guide**:
   - Load appropriate template from `~/.claude/skills/academic-paper-composer/references/section_guides.md`
...
- **Use section templates**: Follow appropriate guide from `~/.claude/skills/academic-paper-composer/references/section_guides.md`
...
1. **Create evaluation document**:
   ```bash
   python ~/.claude/skills/academic-paper-composer/scripts/chapter_quality_check.py
...
1. **Introduction** (write first)
   ...
   - Use introduction guide from `~/.claude/skills/academic-paper-composer/references/section_guides.md`
...
3. **Conclusion** (write after main body)
   ...
   - Use conclusion guide from `~/.claude/skills/academic-paper-composer/references/section_guides.md`

4. **Abstract** (write last)
   - Summarizes complete paper
   - Use abstract guide from `~/.claude/skills/academic-paper-composer/references/section_guides.md`
...
```bash
python ~/.claude/skills/academic-paper-composer/scripts/final_evaluation.py
...
```markdown
~/.claude/skills/academic-paper-composer/references/writing_standards.md
```
...
```markdown
~/.claude/skills/academic-paper-composer/references/section_guides.md
```
...
- I reference `~/.claude/skills/academic-paper-composer/references/section_guides.md` for each section type
